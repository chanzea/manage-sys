    ...
    <div class="task-add-content">
      <Form :model="formItem" :label-width="100">
        ...
        <FormItem label="任务名称">
         ...
         <FormItem label="任务用途">
          <Input v-model="formItem.use" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="描述"></Input>
        </FormItem>
        <FormItem label="标注任务积分">
          <div class="task-mark">
            <span style="margin-right:12px">按</span>
            <Select class="task-mark-select" v-model="formItem.integral">
              <Option value="beijing">New York</Option>
              <Option value="shanghai">London</Option>
              <Option value="shenzhen">Sydney</Option>
            </Select>
            <span style="margin:0 12px">积分,每次</span>
            <Input class="task-mark-input" type="text" placeholder="积分"></Input>
          </div>
        </FormItem>
        <FormItem label="审核任务积分">
          <div class="task-mark">
        ...
        <FormItem label="数据源">
          <Select v-model="formItem.select" placeholder="选择数据源">
            <Option value="beijing">New York</Option>
            <Option value="shanghai">London</Option>
            <Option value="shenzhen">Sydney</Option>
          </Select>
